...
export default function VerifyAccountScreen() {
  ...
  const handleSumbit = async () => {
    ...
    await axios
      ...
      .catch((error) => {
        Toast.show("የ ኦቲፒ ቁጥሮ አይሰራም ወይም አገልግሎት አብቅቷል !", {
          type: "danger",
        });
      });
  };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.headerText}>የቬርፍኬስን ቁጥር</Text>
      <Text style={styles.subText}>
        የቬርፍኬሽን ቁጥር ወደ ኢሜል ቁጥሮ ተልኳል፤ የኢሜሎን ያረጋግጡ
      </Text>
